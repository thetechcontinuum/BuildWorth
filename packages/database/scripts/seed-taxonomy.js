...
async function seedTaxonomy() {
  ...
  const taxonomy = await prisma.skillTaxonomyVersion.upsert({
    ...
    create: {
      version: "1.0.0",
      description:
        "Canonical startup engineering, GTM, design, operations, and compliance skill taxonomy",
      isActive: true,
    },
  });
  ...
  console.log(
    `Successfully seeded ${INITIAL_SKILL_TAXONOMY.length} skills with aliases in taxonomy v1.0.0`,
  );
