...
exports.calculateNormalizedSubscores = calculateNormalizedSubscores;
/**
 * Computes normalized 0 - 100 subscores from evaluated dimension results.
 */
function calculateNormalizedSubscores(dimensions) {
    const getScore = (key) => dimensions.find((d) => d.dimensionKey === key)?.score || 0;
...
//# sourceMappingURL=subscores.js.map