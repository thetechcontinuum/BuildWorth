...
import { getServerAdmin } from "@/lib/admin-page-guard";
import { EnvironmentBanner } from "@/components/EnvironmentBanner";

export const metadata = {
  title: "BuildWorth Admin & Operations Console",
  ...
  return (
    <html lang="en" className="dark">
      <body className="min-h-screen flex flex-col bg-[#09090b] text-zinc-100 antialiased">
        <EnvironmentBanner adminEmail={admin?.email} />
        <div className="flex flex-1 overflow-hidden">
          <aside className="w-64 border-r border-zinc-800/80 bg-zinc-950 p-6 flex flex-col justify-between shrink-0">
            <div className="space-y-6">
              ...
              <nav className="space-y-1 text-sm font-medium text-zinc-400">
                ...
                <Link
                  ...
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                >
                  <Users className="w-4 h-4 text-indigo-400" /> Users & Plans
                </Link>
                <Link
                  href="/sources"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                >
                  <Database className="w-4 h-4 text-indigo-400" /> Sources & Health
                </Link>
                <Link
                  href="/ingestion"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                >
                  <PlaySquare className="w-4 h-4 text-indigo-400" /> Ingestion Runs
                </Link>
                <Link
                  href="/drafts"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                >
                  <Sparkles className="w-4 h-4 text-amber-400" /> Draft Hypotheses
                </Link>
                <Link
                  href="/review-queue"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                ...
                <Link
                  ...
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
                >
                  <BarChart3 className="w-4 h-4" /> Basic Statistics
                </Link>
                <Link
                  href="/ai-spend"
                  className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-zinc-900/60 hover:text-zinc-200 transition-colors"
