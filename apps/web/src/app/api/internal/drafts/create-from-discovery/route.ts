    ...
    const draftsToCreate = [
      {
        ...
        potentialEuAdaptation: "Under EU Battery Regulation (EU 2023/1542, Art. 77), Digital Battery Passports become mandatory on 18 February 2027, alongside phased carbon footprint declarations. Croatian and European automotive suppliers (e.g. Rimac Technology supply tiers) face compliance overhead collecting verified carbon credentials from Asian raw material suppliers without expensive bespoke consulting.",
      ...
      },
      {
        ...
        potentialEuAdaptation: "Croatian logistics corridors and EU industrial facilities face strict workplace safety audits. On-premise edge video analysis avoids third-country cloud video streaming, but workplace monitoring still requires mandatory Data Protection Impact Assessments (DPIA under Art. 35 GDPR), worker notification, works council consultation, and strict access controls under applicable national labor laws.",
